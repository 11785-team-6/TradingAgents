...
#
# Hybrid (signals) - high_volatility_shock window (mid3).

set -euo pipefail

PROJECT_ROOT="/ocean/projects/cis260081p/chsu11/hybrid/TradingAgents"
CONFIG_PATH="agent_experiment/configs/hvs/pilot_hvs_hybrid_signals_mid3.yaml"
export CONFIG_PATH
OLLAMA_PORT=11450
