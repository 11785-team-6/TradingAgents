#!/bin/bash
#SBATCH --job-name=hvs-sig-worst2
#SBATCH -p GPU-shared
...
#
# Hybrid (signals) - high_volatility_shock window (worst2).

set -euo pipefail

PROJECT_ROOT="/ocean/projects/cis260081p/chsu11/hybrid/TradingAgents"
CONFIG_PATH="agent_experiment/configs/hvs/pilot_hvs_hybrid_signals_worst2.yaml"
export CONFIG_PATH
OLLAMA_PORT=11451
