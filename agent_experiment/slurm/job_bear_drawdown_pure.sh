...
#
# Pure agent — bear_drawdown window (2025-10-27 .. 2025-11-25).

set -euo pipefail

PROJECT_ROOT="/ocean/projects/cis260081p/chsu11/hybrid/TradingAgents"
CONFIG_TEMPLATE="agent_experiment/configs/pilot_bear_drawdown_pure.yaml"
...
FROZEN_CONFIG="agent_experiment/configs/frozen/job_${JOB_TAG}_pilot_bear_drawdown_pure.yaml"
