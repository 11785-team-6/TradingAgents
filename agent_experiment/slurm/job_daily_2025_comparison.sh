...
PURE_ROOT="${GROUP_ROOT}/all_year_pure"
BASE_METRICS_ROOT="${GROUP_ROOT}/all_year_hybrid_metrics"
BASE_SIGNALS_ROOT="${GROUP_ROOT}/all_year_hybrid_signals"
OUTPUT_DIR="${GROUP_ROOT}/all_year_final_comparison"
