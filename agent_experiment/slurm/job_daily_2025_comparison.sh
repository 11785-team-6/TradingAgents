...
PURE_DIR="${PROJECT_ROOT}/outputs/all_year_pure/20260419T045325Z"
HYBRID_METRICS_DIR="${PROJECT_ROOT}/outputs/all_year_hybrid_metrics/20260419T050112Z"
HYBRID_SIGNALS_DIR="${PROJECT_ROOT}/outputs/all_year_hybrid_signals/20260419T045325Z"
...
--run-id "${DEEP_RUN_ID}" \
--symbol "${SYMBOL}" \
--output "${PROJECT_ROOT}/outputs/all_year_final_comparison"

echo "Done. Final report under: ${PROJECT_ROOT}/outputs/all_year_final_comparison"