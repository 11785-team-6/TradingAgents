#!/bin/bash
#SBATCH --job-name=ay-compare-split
#SBATCH -p GPU-shared
...
#
# Build final comparison table for all_year (base + split arms).
...
PURE_ROOT="${PROJECT_ROOT}/outputs/all_year_pure"
WINDOW="all_year"
WINDOW_SHORT="ay"
BASE_METRICS_ROOT="${PROJECT_ROOT}/outputs/all_year_hybrid_metrics"
BASE_SIGNALS_ROOT="${PROJECT_ROOT}/outputs/all_year_hybrid_signals"
OUTPUT_DIR="${PROJECT_ROOT}/outputs/all_year_final_comparison"
