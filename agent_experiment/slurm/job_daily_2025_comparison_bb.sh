#!/bin/bash
#SBATCH --job-name=bb-compare-split
#SBATCH -p GPU-shared
...
PURE_ROOT="${GROUP_ROOT}/bull_breakout_pure"
BASE_METRICS_ROOT="${GROUP_ROOT}/bull_breakout_hybrid"
BASE_SIGNALS_ROOT="${GROUP_ROOT}/bull_breakout_hybrid_signals"
OUTPUT_DIR="${GROUP_ROOT}/bull_breakout_final_comparison"
