...
PURE_DIR="${PROJECT_ROOT}/outputs/bull_breakout_pure/20260418T131433Z"
HYBRID_METRICS_DIR="${PROJECT_ROOT}/outputs/bull_breakout_hybrid/20260418T131433Z"
HYBRID_SIGNALS_DIR="${PROJECT_ROOT}/outputs/bull_breakout_hybrid_signals/20260418T131433Z"
...
python -m agent_experiment.scripts.run_experiment_comparison \
  ...
  --run-id "${DEEP_RUN_ID}" \
  --symbol "${SYMBOL}" \
  --output "${PROJECT_ROOT}/outputs/bull_breakout_final_comparison"

echo "Done. Final report under: ${PROJECT_ROOT}/outputs/bull_breakout_final_comparison"
