...
PURE_ROOT="${GROUP_ROOT}/bear_drawdown_pure"
BASE_METRICS_ROOT="${GROUP_ROOT}/bear_drawdown_hybrid"
BASE_SIGNALS_ROOT="${GROUP_ROOT}/bear_drawdown_hybrid_signals"
OUTPUT_DIR="${GROUP_ROOT}/bear_drawdown_final_comparison"
