...
#
# Hybrid (metrics) — high_volatility_shock window.

set -euo pipefail

PROJECT_ROOT="/ocean/projects/cis260081p/chsu11/hybrid/TradingAgents"
CONFIG_TEMPLATE="agent_experiment/configs/pilot_high_volatility_shock_hybrid.yaml"
...
FROZEN_CONFIG="agent_experiment/configs/frozen/job_${JOB_TAG}_pilot_high_volatility_shock_hybrid.yaml"
